...
> **컨트롤러에 /login API가 없어 소셜로그인을 구현하지 않은 것처럼 보일 수 있는데.**
> **클라이언트에서 하이퍼링크로 로그인 링크로 이동만 하면 모두 백엔드에서 소셜로그인 과정을 진행하여 /login API를 이용하지 않습니다.**
...
<img width="869" alt="스크린샷 2024-07-25 오후 3 49 38" src="https://github.com/user-attachments/assets/506b5954-1517-4343-be90-d9b2e3a7a4cd">
<img width="660" alt="스크린샷 2024-07-25 오후 3 49 55" src="https://github.com/user-attachments/assets/fd4d0490-dc53-4b78-b0da-4f4bec3ca6ee">

2. 구글 소셜로그인 진행 시 처음 로그인을 하여 온보딩을 하지 않은 유저일 경우
   http://localhost:5173/onboarding?userId=" + userId 로 이동되고 userId와 request(닉네임, 나이, 직업) 을 이용하여 온보딩을 진행한다 (토큰 아직 발급 x, 데이터베이스에 온보딩을 제외한 기본 user 정보만 들어감)
   이미 온보딩까지 진행한 유저일 경우
   http://localhost:5173으로 바로 이동 (쿠키에 토큰 발급)
<img width="429" alt="스크린샷 2024-07-25 오후 3 55 24" src="https://github.com/user-attachments/assets/d13777fb-ff2d-4990-adad-008dc579b946">
- 온보딩을 하지 않은 User -
<img width="1078" alt="스크린샷 2024-07-25 오후 4 04 03" src="https://github.com/user-attachments/assets/313cf6fd-34ac-4fa6-808d-08938a522124">
- 온보딩을 한 User - 
<img width="1236" alt="스크린샷 2024-07-25 오후 4 14 33" src="https://github.com/user-attachments/assets/8f195a1f-c32a-4a28-80dd-83ce6caea5ec">
<img width="671" alt="스크린샷 2024-07-25 오후 4 06 36" src="https://github.com/user-attachments/assets/372c2a69-90a8-4375-b459-225892260f8f">
...
CREATE TABLE onboarding (
            ...
            CONSTRAINT fk_onboarding FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE
);
...
CREATE TABLE refresh_token (
            ...
            CONSTRAINT fk_refresh_token FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE
);
